...
public class C04_WebElementMethodlari {
    ...
    public static void main(String[] args) {
        ...
        //2- arama kutusunun tagName'inin input oldugunu test edin
        String expectedTagName = "input"; //BEKLENEN
        String actualTagName=aramaKutusu.getTagName(); //GERCEK
        ...
        System.out.println("konumu : "+aramaKutusu.getLocation());
        System.out.println("webelement yuksekligi : " +aramaKutusu.getSize().height);
        // konum ve yuksekligi QA lere pek yaptirmazlar
